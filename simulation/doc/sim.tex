...
\emp{Notice that the reasoning for modeling $ADO$ only on
  $l$ is, again, to focus on the problematic cases for variant
  calling. However, if desired, it is possible to, e.g., set $R_{ADO}
  = \{l_1,l_2, l'_1, l'_2\}$.}
